...
cdef class RobotFileParser:

    cdef object entries
    cdef int disallow_all
    cdef int allow_all
    cdef int last_checked
    cdef int cache_val
    cdef int errcode
    
    # Cuz this can be Unicode
...
cdef class Entry:
    ...
    cdef public object useragents
    cdef public object rulelines
